...
export class XPub {
    ...
    */
    static new() {
        const ret = wasm.xpub_new();
        return XPub.__wrap(ret);
    }
    /**
    * @returns {string}
    */
    mnemonic() {
        try {
            ...
            wasm.xpub_mnemonic(retptr, this.ptr);
    ...
    */
    xpub() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.xpub_xpub(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
    ...
    */
    fingerprint() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.xpub_fingerprint(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasm_new_xpub_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
